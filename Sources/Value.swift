...
func get(property pointer: UnsafeMutablePointer<GObject>?, name: String) -> Bool {
    var v = GValue()
...
func set(property pointer: UnsafeMutablePointer<GObject>?, name: String, newValue: Bool) {
    var v = GValue()
    let type = GType(5 << G_TYPE_FUNDAMENTAL_SHIFT)
    let value = g_value_init(&v, type)
...
func get(property pointer: UnsafeMutablePointer<GObject>?, name: String) -> Int {
    var v = GValue()
...
func set(property pointer: UnsafeMutablePointer<GObject>?, name: String, newValue: Int) {
    var v = GValue()
    let type = GType(6 << G_TYPE_FUNDAMENTAL_SHIFT)
    let value = g_value_init(&v, type)
